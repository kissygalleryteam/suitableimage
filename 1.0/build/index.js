...
gallery/suitableimage/1.0/index

*/
KISSY.add('gallery/suitableimage/1.0/index',function(S, DOM, Node) {
  ...
  SuitableImage = (function() {
    function SuitableImage(config) {
      ...
      if (!this.config.lazyload) {
        $(el).append(DOM.create("<div style=\"width:100%;height:100%;background:url(" + this.config.image + ");\"></div>"));
      } else {
